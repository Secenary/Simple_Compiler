 ...
 * @see NonTerminal 非终止符 - 可以通过产生式被其它项规约出来的项
 * @see Production 产生式 - BNF 语法描述的基本要素
 */
